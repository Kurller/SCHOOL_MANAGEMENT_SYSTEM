        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-violet-600 via-fuchsia-600 to-pink-600 px-6 py-4">
                    <h3 class="text-xl font-bold text-white">Mark Attendance</h3>
                </div>
                    ...
                    <form action="{{ route('attendances.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="student_id" class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition duration-200">
                            ...
                            <div>
                                ...
                                <select name="school_class_id" class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition duration-200">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <textarea
                                    name="remarks"
                                    rows="3"
                                    class="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-violet-500 focus:border-violet-500 transition duration-200"></textarea>
                            </div>
